...
class Test1 {
	 ...
	 * @param Площадь = 300
	 * @param Жильцы = 5
	 * @param Отопление = 100.00
	 * @param Холодная вода = 100.00
	...
	public void test() {
		 ...
		 */
		double testValue = 235379.96;/*переменная с которой происходит сравнение, значение теста*/
		...
		int numberOfPersons = 5;/*Жильцы*/
		double heating = 100.00;/*Отопление*/
		double coldWater = 100.00;/*Холодная вода*/
		double hotWater = 100.00;/*Горячая вода*/
		double gas = 100.00;/*Газ*/
		int toggle = 3;/*Выбор фазы*/
		double fase1 = 250.00;/*Тарифная зона 1*/
		double fase2 = 200.00;/*Тарифная зона 2*/
		double fase3 = 300.00;/*Тарифная зона 2*/
		/**
		...
		Function1 function = new Function1(checkBoxList, doubleListValue, doubleListValueEnergy, toggle);/*Создание переменной function типа Function*/
...
class Values1 {
	 ...
	 * @param toggle
	 */
	public Values1(ArrayList<JCheckBox> checkBoxList, ArrayList<Double> doubleListValue,  ArrayList<Double> doubleListValueEnergy, int toggle) {
		/**
 ...
 *
 */
class Function1 extends Values1 {
	 ...
	 * @param toggle
	 */
	public Function1(ArrayList<JCheckBox> checkBoxList, ArrayList<Double> doubleListValue, ArrayList<Double> doubleListValueEnergy, int toggle) {
