...
/**
 * @author 18130166
 * <h1>РљР»Р°СЃСЃ Test2</h1>
 * <h2>РџСЂРѕРІРѕРґРёС‚ С‚РµСЃС‚</h2>
 */
class Test2 {

	/**
	* <h1>РњРµС‚РѕРґ test РєР»Р°СЃСЃР° Test2</h1>
	...
	* @param РџР»РѕС‰Р°РґСЊ = 70
* @param Р–РёР»СЊС†С‹ = 4
* @param РћС‚РѕРїР»РµРЅРёРµ = 90.00
* @param РҐРѕР»РѕРґРЅР°СЏ РІРѕРґР° = 170.00
* @param Р“РѕСЂСЏС‡Р°СЏ РІРѕРґР° = 100.00
* @param Р“Р°Р· = 120.00
* @param Р’С‹Р±РѕСЂ С„Р°Р·С‹ СЃС‡РµС‚С‡РёРєР° СЌР»РµРєС‚СЂРѕСЌРЅРµСЂРіРёРё = 1
* @param РўР°СЂРёС„РЅР°СЏ Р·РѕРЅР° 1 = 500.00	 * 
	*/
	...
	public void test() {
		 ...
		 */
		double testValue = 211127.46;/*РїРµСЂРµРјРµРЅРЅР°СЏ СЃ РєРѕС‚РѕСЂРѕР№ РїСЂРѕРёСЃС…РѕРґРёС‚ СЃСЂР°РІРЅРµРЅРёРµ, Р·РЅР°С‡РµРЅРёРµ С‚РµСЃС‚Р°*/
		 ...
		 */
		double area = 70.00;/*РџР»РѕС‰Р°РґСЊ*/
		int numberOfPersons = 4;/*Р–РёР»СЊС†С‹*/
		double heating = 90.00;/*РћС‚РѕРїР»РµРЅРёРµ*/
		double coldWater = 170.00;/*РҐРѕР»РѕРґРЅР°СЏ РІРѕРґР°*/
		double hotWater = 100.00;/*Р“РѕСЂСЏС‡Р°СЏ РІРѕРґР°*/
		double gas = 120.00;/*Р“Р°Р·*/
		int toggle = 1;/*Р’С‹Р±РѕСЂ С„Р°Р·С‹*/
		double fase1 = 250.00;/*РўР°СЂРёС„РЅР°СЏ Р·РѕРЅР° 1*/
		...
		Function2 function = new Function2(checkBoxList, doubleListValue, doubleListValueEnergy, toggle);/*РЎРѕР·РґР°РЅРёРµ РїРµСЂРµРјРµРЅРЅРѕР№ Function2 С‚РёРїР° Function2*/
		function.initialize();/*Р’С‹РїРѕР»РЅСЏРµС‚СЃСЏ СЂР°СЃС‡РµС‚*/
		testingValue = function.getValue(); /*Р·РЅР°С‡РµРЅРёРµ РїРµСЂРµРјРµРЅРЅРѕР№ Value РёР· РєР»Р°СЃСЃР° Function2*/
...
class Values2 {
	...
	/**
	 * <h1>РЎСѓРїРµСЂ РєР»Р°СЃСЃ РєР»Р°СЃСЃР° Values2</h1>
	 ...
	 * @param toggle
	 */
	public Values2(ArrayList<JCheckBox> checkBoxList, ArrayList<Double> doubleListValue,  ArrayList<Double> doubleListValueEnergy, int toggle) {
		/**
 ...
 * 
 * @author 18130166
 * <h1>РљР»Р°СЃСЃ Function2</h1>
 * <h2>РњР°С‚РµРјР°С‚РёС‡РµСЃРєР°СЏ РјРѕРґРµР»СЊ, РІС‹РїРѕР»РЅСЏРµС‚ СЂР°СЃС‡РµС‚С‹</h2>
 *
 */
class Function2 extends Values2 {
	
	/**
	 * <h1>РЎСѓРїРµСЂ РєР»Р°СЃСЃ РєР»Р°СЃСЃР° Function22</h1>
	 * <h2>РџРµСЂРµРјРµРЅРЅС‹Рµ РЅРµРѕР±С…РѕРґРёРјС‹Рµ РґР»СЏ СЂР°СЃС‡РµС‚Р°:</h2>
	 * @param checkBoxList
	 * @param doubleListValue
	 * @param doubleListValueEnergy
	 * @param toggle
	 */
	public Function2(ArrayList<JCheckBox> checkBoxList, ArrayList<Double> doubleListValue, ArrayList<Double> doubleListValueEnergy, int toggle) {
	...
	/**
	 * <h1>РњРµС‚РѕРґ initialize РєР»Р°СЃСЃР° Function2</h1>
	...
	public void initialize() {
		...
		*/
		getDoubleListTarif().add(0, 0.16);/*РЎРѕРґРµСЂР¶Р°РЅРёРµ*/
	...
	/**
	 * <h1>РњРµС‚РѕРґ setValueOf РєР»Р°СЃСЃР° Function2</h1>
	...
	/**
	 * <h1>РњРµС‚РѕРґ round РєР»Р°СЃСЃР° Function2</h1>
