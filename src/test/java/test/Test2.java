...
* @param Тарифная зона 1 = 500.00	 * 
	*/
	...
	public void test() {
		...
		Function2 function = new Function2(checkBoxList, doubleListValue, doubleListValueEnergy, toggle);/*Создание переменной Function2 типа Function2*/
...
class Values2 {
	...
	/**
	 * <h1>Супер класс класса Values2</h1>
...
class Function2 extends Values2 {
	...
	/**
	 * <h1>Супер класс класса Function22</h1>
	 * <h2>Переменные необходимые для расчета:</h2>
	 * @param checkBoxList
	 * @param doubleListValue
	 * @param doubleListValueEnergy
	...
	/**
	 * <h1>Метод initialize класса Function2</h1>
	...
	/**
	 * <h1>Метод setValueOf класса Function2</h1>
	...
	/**
	 * <h1>Метод round класса Function2</h1>
