...
class Test6 {
	 ...
	 * @param Тарифная зона 1 = 190
	 * @param Тарифная зона 2 = 230
       * @param Тарифная зона 3 = 300
	...
	public void test() {
		 ...
		 */
		double testValue = 303389.06;/*переменная с которой происходит сравнение, значение теста*/
		double testingValue = 0;/*перенная с которой происходит сравнение, значение переменной Value из класса Function6 */
		...
		double gas = 140.00;/*Газ*/
		int toggle = 3;/*Выбор фазы*/
		double fase1 = 190.00;/*Тарифная зона 1*/
		double fase2 = 230.00;/*Тарифная зона 2*/
		double fase3 = 300.00;/*Тарифная зона 3*/
		...
		Function6 function = new Function6(checkBoxList, doubleListValue, doubleListValueEnergy, toggle);/*Создание переменной function типа Function6*/
		function.initialize();/*Выполняется расчет*/
		testingValue = function.getValue(); /*значение переменной Value из класса Function6*/
...
class Values6 {
	...
	/**
	 * <h1>Супер класс класса Values6</h1>
	 ...
	 * @param toggle
	 */
	public Values6(ArrayList<JCheckBox> checkBoxList, ArrayList<Double> doubleListValue,  ArrayList<Double> doubleListValueEnergy, int toggle) {
		/**
 ...
 * 
 * @author Roman
 * <h1>Класс Function6</h1>
 * <h2>Математическая модель, выполняет расчеты</h2>
 *
 */
class Function6 extends Values6 {
	
	/**
	 * <h1>Супер класс класса Function6</h1>
	 * <h2>Переменные необходимые для расчета:</h2>
	 * @param checkBoxList
	 * @param doubleListValue
	 * @param doubleListValueEnergy
	 * @param toggle
	 */
	public Function6(ArrayList<JCheckBox> checkBoxList, ArrayList<Double> doubleListValue, ArrayList<Double> doubleListValueEnergy, int toggle) {
		super(checkBoxList, doubleListValue, doubleListValueEnergy, toggle);/*Переменные при инициализации класса*/
	}
	
	/**
	 * <h1>Метод initialize класса Function6</h1>
	...
	/**
	 * <h1>Метод setValueOf класса Function6</h1>
	...
	/**
	 * <h1>Метод round класса Function6</h1>
