...
* @param Тарифная зона 3 = 280.00	 * 
	...
	public void test() {
		...
		Function5 function = new Function5(checkBoxList, doubleListValue, doubleListValueEnergy, toggle);/*Создание переменной function типа Function5*/
...
class Values5 {
	...
	/**
	 * <h1>Супер класс класса Values5</h1>
	 ...
	 * @param toggle
	 */
	public Values5(ArrayList<JCheckBox> checkBoxList, ArrayList<Double> doubleListValue,  ArrayList<Double> doubleListValueEnergy, int toggle) {
		/**
 ...
 * 
 * @author Roman
 * <h1>Класс Function5</h1>
 * <h2>Математическая модель, выполняет расчеты</h2>
 *
 */
class Function5 extends Values5 {
	
	/**
	 * <h1>Супер класс класса Function5</h1>
	 * <h2>Переменные необходимые для расчета:</h2>
	 * @param checkBoxList
	 * @param doubleListValue
	 * @param doubleListValueEnergy
	 * @param toggle
	 */
	public Function5(ArrayList<JCheckBox> checkBoxList, ArrayList<Double> doubleListValue, ArrayList<Double> doubleListValueEnergy, int toggle) {
		super(checkBoxList, doubleListValue, doubleListValueEnergy, toggle);/*Переменные при инициализации класса*/
	}
	
	/**
	 * <h1>Метод initialize класса Function5</h1>
	...
	/**
	 * <h1>Метод setValueOf класса Function5</h1>
	...
	/**
	 * <h1>Метод round класса Function5</h1>
