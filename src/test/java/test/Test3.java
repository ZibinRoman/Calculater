...
class Test3 {
	/**
	 * <h1>Метод test класса Test3</h1>
	 * <br><i>Выполняет тест, по математической модели</i></br>
	 * <br><i>Первый тест</i></br>
	 * <h1>Вводимые значения:</h1>
	 * @param Площадь = 70
 * @param Жильцы = 2
 * @param Отопление = 170.00
 * @param Холодная вода = 250.00
 * @param Горячая вода = 160.00
 * @param Газ = 210.00
 * @param Выбор фазы счетчика электроэнергии = 2
 * @param Тарифная зона 1 = 250.00
 * @param Тарифная зона 2 = 150.00	 
	 */
	...
	public void test() {
		 ...
		 */
		double testValue = 390586.56;/*переменная с которой происходит сравнение, значение теста*/
		double testingValue = 0;/*перенная с которой происходит сравнение, значение переменной Value из класса Function3 */
		...
		double heating = 170.00;/*Отопление*/
		double coldWater = 250.00;/*Холодная вода*/
		double hotWater = 160.00;/*Горячая вода*/
		double gas = 210.00;/*Газ*/
		int toggle = 2;/*Выбор фазы*/
		double fase1 = 250.00;/*Тарифная зона 1*/
		double fase2 = 150.00;/*Тарифная зона 2*/
		/**
		...
		Function3 function = new Function3(checkBoxList, doubleListValue, doubleListValueEnergy, toggle);/*Создание переменной function типа Function3*/
		function.initialize();/*Выполняется расчет*/
		testingValue = function.getValue(); /*значение переменной Value из класса Function3*/
...
class Values3 {
	...
	/**
	 * <h1>Супер класс класса Values3</h1>
	 ...
	 * @param toggle
	 */
	public Values3(ArrayList<JCheckBox> checkBoxList, ArrayList<Double> doubleListValue,  ArrayList<Double> doubleListValueEnergy, int toggle) {
		/**
 ...
 * 
 * @author 18130166
 * <h1>Класс Function3</h1>
 * <h2>Математическая модель, выполняет расчеты</h2>
 *
 */
class Function3 extends Values3 {
	
	/**
	 * <h1>Супер класс класса Function3</h1>
	 * <h2>Переменные необходимые для расчета:</h2>
	 * @param checkBoxList
	 * @param doubleListValue
	 * @param doubleListValueEnergy
	 * @param toggle
	 */
	public Function3(ArrayList<JCheckBox> checkBoxList, ArrayList<Double> doubleListValue, ArrayList<Double> doubleListValueEnergy, int toggle) {
		super(checkBoxList, doubleListValue, doubleListValueEnergy, toggle);/*Переменные при инициализации класса*/
	}
	
	/**
	 * <h1>Метод initialize класса Function3</h1>
	...
	/**
	 * <h1>Метод setValueOf класса Function3</h1>
	...
	/**
	 * <h1>Метод round класса Function3</h1>
