...
class Test4 {
	...
	public void test() {
		...
		Function4 function = new Function4(checkBoxList, doubleListValue, doubleListValueEnergy, toggle);/*Создание переменной function типа Function4*/
...
class Values4 {
	...
	/**
	 * <h1>Супер класс класса Values4</h1>
	 ...
	 * @param toggle
	 */
	public Values4(ArrayList<JCheckBox> checkBoxList, ArrayList<Double> doubleListValue,  ArrayList<Double> doubleListValueEnergy, int toggle) {
		/**
 ...
 * 
 * @author Roman
 * <h1>Класс Function4</h1>
 * <h2>Математическая модель, выполняет расчеты</h2>
 *
 */
class Function4 extends Values4 {
	
	/**
	 * <h1>Супер класс класса Function4</h1>
	 * <h2>Переменные необходимые для расчета:</h2>
	 * @param checkBoxList
	 * @param doubleListValue
	 * @param doubleListValueEnergy
	 * @param toggle
	 */
	public Function4(ArrayList<JCheckBox> checkBoxList, ArrayList<Double> doubleListValue, ArrayList<Double> doubleListValueEnergy, int toggle) {
		super(checkBoxList, doubleListValue, doubleListValueEnergy, toggle);/*Переменные при инициализации класса*/
	}
	
	/**
	 * <h1>Метод initialize класса Function4</h1>
	...
	/**
	 * <h1>Метод setValueOf класса Function4</h1>
	...
	/**
	 * <h1>Метод round класса Function4</h1>
