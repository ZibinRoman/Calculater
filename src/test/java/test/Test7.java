...
* @param Тарифная зона 2 = 100 	 * 
	...
	public void test() {
		...
		Function7 function = new Function7(checkBoxList, doubleListValue, doubleListValueEnergy, toggle);/*Создание переменной function типа Function7*/
...
class Values7 {
	...
	/**
	 * <h1>Супер класс класса Values7</h1>
	 ...
	 * @param toggle
	 */
	public Values7(ArrayList<JCheckBox> checkBoxList, ArrayList<Double> doubleListValue,  ArrayList<Double> doubleListValueEnergy, int toggle) {
		/**
 ...
 * 
 * @author Roman
 * <h1>Класс Function7</h1>
 * <h2>Математическая модель, выполняет расчеты</h2>
 *
 */
class Function7 extends Values7 {
	
	/**
	 * <h1>Супер класс класса Function7</h1>
	 * <h2>Переменные необходимые для расчета:</h2>
	 * @param checkBoxList
	 * @param doubleListValue
	 * @param doubleListValueEnergy
	 * @param toggle
	 */
	public Function7(ArrayList<JCheckBox> checkBoxList, ArrayList<Double> doubleListValue, ArrayList<Double> doubleListValueEnergy, int toggle) {
		super(checkBoxList, doubleListValue, doubleListValueEnergy, toggle);/*Переменные при инициализации класса*/
	}
	
	/**
	 * <h1>Метод initialize класса Function7</h1>
	...
	/**
	 * <h1>Метод setValueOf класса Function7</h1>
	...
	/**
	 * <h1>Метод round класса Function7</h1>
