...
class Test3 {
	/**
	 * <h1>РњРµС‚РѕРґ test РєР»Р°СЃСЃР° Test3</h1>
 ...
 * @param Р–РёР»СЊС†С‹ = 2
 * @param РћС‚РѕРїР»РµРЅРёРµ = 170.00
 * @param РҐРѕР»РѕРґРЅР°СЏ РІРѕРґР° = 250.00
 * @param Р“РѕСЂСЏС‡Р°СЏ РІРѕРґР° = 160.00
 * @param Р“Р°Р· = 210.00
 * @param Р’С‹Р±РѕСЂ С„Р°Р·С‹ СЃС‡РµС‚С‡РёРєР° СЌР»РµРєС‚СЂРѕСЌРЅРµСЂРіРёРё = 2
 * @param РўР°СЂРёС„РЅР°СЏ Р·РѕРЅР° 1 = 250.00
 * @param РўР°СЂРёС„РЅР°СЏ Р·РѕРЅР° 2 = 150.00	 
	 */
	...
	public void test() {
		 ...
		 */
		double testValue = 390586.56;/*РїРµСЂРµРјРµРЅРЅР°СЏ СЃ РєРѕС‚РѕСЂРѕР№ РїСЂРѕРёСЃС…РѕРґРёС‚ СЃСЂР°РІРЅРµРЅРёРµ, Р·РЅР°С‡РµРЅРёРµ С‚РµСЃС‚Р°*/
		...
		double heating = 170.00;/*РћС‚РѕРїР»РµРЅРёРµ*/
		double coldWater = 250.00;/*РҐРѕР»РѕРґРЅР°СЏ РІРѕРґР°*/
		double hotWater = 160.00;/*Р“РѕСЂСЏС‡Р°СЏ РІРѕРґР°*/
		double gas = 210.00;/*Р“Р°Р·*/
		int toggle = 2;/*Р’С‹Р±РѕСЂ С„Р°Р·С‹*/
		double fase1 = 250.00;/*РўР°СЂРёС„РЅР°СЏ Р·РѕРЅР° 1*/
		double fase2 = 150.00;/*РўР°СЂРёС„РЅР°СЏ Р·РѕРЅР° 2*/
		/**
